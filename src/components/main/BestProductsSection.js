...
const BestProductsSection = () => {
    const products = [
        { id: 1, img: cdImg01, imgHover: cdImg01Hover, title: "의류형" },
        { id: 2, img: cdImg02, imgHover: cdImg02Hover, title: "기본형"},
        { id: 3, img: cdImg03, imgHover: cdImg03Hover, title: "대형견 추천형"},
        { id: 4, img: cdImg04, imgHover: cdImg04Hover, title: "목 편한 유형"}
    ];
